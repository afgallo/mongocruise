      ...
      const handler = async (request, h) => {
        ...
        switch (operation.toLowerCase()) {
          ...
          case 'insertone': {
            ...
            if (setTimestamps) {
              request.payload.createdAt = new Date().getTime()
              request.payload.updatedAt = new Date().getTime()
            }
          ...
          case 'updateone': {
            ...
            result = await db
              ...
              .updateOne({ [queryParam]: new ObjectId(request.params[queryParam]) }, { $set: request.payload })
            break
          }
